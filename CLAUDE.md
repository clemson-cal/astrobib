...
Read [docs/DESIGN.md](docs/DESIGN.md) before adding features or changing data formats. It is the authoritative statement of design constraints. [docs/STATUS.md](docs/STATUS.md) tracks implementation status.
